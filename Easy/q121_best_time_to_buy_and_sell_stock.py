class Solution:
    def maxProfit(self, prices: list[int]) -> int:
        ...
        #         if prices[n] > prices[firstLowestPoint] and firstCount == True:
        #             secondCount = True
        #             if prices[n] - prices[firstLowestPoint] > firstProfit:
        #                 firstProfit = prices[n] - prices[firstLowestPoint]

        #     if firstCount == False and secondCount == True:
        #         if prices[n] < prices[n - 1]:
        #             if thirdCount == False:
        #                 secondLowestPoint = n
        #             else:
        #                 if prices[n] < prices[secondLowestPoint]:
        #                     secondLowestPoint = n
        #                 thirdCount = False

        #         if prices[n] > prices[secondLowestPoint]:
        #             thirdCount = True
        #             secondProfit = prices[n] - prices[secondLowestPoint]

        #             if prices[n] - prices[firstLowestPoint] > firstProfit:
        #                 firstProfit = prices[n] - prices[firstLowestPoint]

        #     if secondProfit > firstProfit:
        #         firstLowestPoint = secondLowestPoint
        #         firstCount = True
        #         secondCount = False
        #         thirdCount = False
